...
class RetroAvanzado : AppCompatActivity() {
    @SuppressLint("MissingInflatedId")
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_retro_avanzado)
        ...
        val s1 : ImageView = findViewById(R.id.asi1)
        val s2 : ImageView = findViewById(R.id.asi2)
        val s3 : ImageView = findViewById(R.id.asi3)
        val s4 : ImageView = findViewById(R.id.asi4)
        val s5 : ImageView = findViewById(R.id.asi5)

        val n1 : ImageView = findViewById(R.id.vno1)
        val n2 : ImageView = findViewById(R.id.vno2)
        val n3 : ImageView = findViewById(R.id.vno3)
        val n4 : ImageView = findViewById(R.id.vno4)
        val n5 : ImageView = findViewById(R.id.vno5)
